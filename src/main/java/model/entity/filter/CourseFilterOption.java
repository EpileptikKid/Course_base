...
public class CourseFilterOption {
    ...
    public CourseFilterOption(User tutor, Theme theme, User availableForStudent, CourseStatus courseStatus) {
        this.tutor = tutor;
        this.theme = theme;
    ...
    public User getAvailableForStudent() { return availableForStudent; }

    public void setAvailableForStudent(User availableForStudent) { this.availableForStudent = availableForStudent; }
    ...
    public static class Builder {
        ...
        public CourseFilterOption build() { return new CourseFilterOption(tutor, theme, student, courseStatus); }
    }
