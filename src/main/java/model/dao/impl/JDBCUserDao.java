...
public class JDBCUserDao extends JDBCAbstractDao implements UserDao {
    ...
    private static final String GET_USER_BY_ROLE;
    private static final String GET_USER_BY_LOGIN;
    private static final String FIND_ALL_USERS;
    private static final String CHANGE_USER_BLOCK_STATUS;
    ...
    static {
        ...
        GET_USER_BY_ROLE = sqlStatementLoader.getSqlStatement("getUsersByRole");
    ...
    @Override
    public List<User> findUserByRole(User.Role role) throws DBException {
    ...
    @Override
    public void userUpdateIsBlockedStatus(User user) throws DBException, EntityNotFoundException {
